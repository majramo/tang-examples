...
public class LinkedInTextAndValueComparisonHtmlDto extends HtmlXmlBaseDto {

    protected LinkedInTextAndValueComparisonHtmlDto(Map context, String htmlXmlSource, priority) {
