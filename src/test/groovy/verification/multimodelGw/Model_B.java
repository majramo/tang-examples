...
public class Model_B extends AnyMbtTest {

    private static final long SLEEP = 50000;

    public Model_B(File model, boolean efsm, PathGenerator generator, boolean weight, String browser, String outputDirectory) {
